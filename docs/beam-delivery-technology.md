...
??? abstract "Summary — AI-generated, curator-reviewed"
    This study presents a target-specific passive scattering setup for small-field proton irradiation using 3D-printed polylactide containers filled with reusable copper or polypropylene spheres as collimating and compensating elements, designed via a modified Porespy Python package and validated with TOPAS Monte Carlo simulations. The authors compared solid collimators to their sphere-packed approach and built two feasibility setups: one for a simple spherical target and one for a complex murine brain tumor shape. Depth-dose curves and beam-size measurements agreed with simulations within a few percent, though a dose halo was observed at high energies because protons were not fully stopped by the plastic bore, suggesting higher-density materials are needed. Print time was under 45 minutes and filament cost under $1 per setup, with dose conformity to target shape demonstrated by measurement.
...
??? abstract "Summary — AI-generated, curator-reviewed"
    This study develops a mathematical optimization framework for designing multiple-ring double-scattering systems for a 70 MeV cyclotron used in ocular proton therapy at HZB, aiming to maximize beam transmission under a field-homogeneity constraint. A Python GUI implements the optimization for two- to four-ring configurations, incorporating energy degradation, range shifting, and conversion of scattering angles to physical ring dimensions. The four-ring design achieved 53±2% transmission with ±3% dose homogeneity, corresponding to a dose rate of 77 Gy/s at 100 nA for a 30 mm field, exceeding commonly cited FLASH dose-rate thresholds. Bragg-peak measurements and TOPAS Monte Carlo simulations confirmed a distal penumbra below 1 mm and water-range agreement within 0.1 mm of predictions. The four-ring system increased transmission more than tenfold relative to single scattering.
...
### Radiation protection strategies for FLASH radiotherapy accelerator installation in animal housing.

*Russo G, Bonaccorsi SG, Leanza R, Costa M, Pucci G, Alberghina C et al.* — Radiation protection dosimetry (2026)  

<span class="badge tag">Beam Delivery &amp; Technology</span> <span class="badge tag">Modeling &amp; Mechanisms</span>


**TL;DR.** This study presents a radioprotection assessment for an ultra-high dose rate accelerator installation in one of the animal housing of the Centre for Advanced Preclinical in vivo Research. The main problem concerns the absence of a bunker while limiting exposure in nearby work areas.


??? abstract "Summary — AI-generated, curator-reviewed"
    This study reports a radiation protection assessment for installing an ultra-high dose rate 9 MeV electron accelerator in an animal housing facility without a dedicated bunker. Using FLUKA.CERN 4-4.1 Monte Carlo simulations of the accelerator geometry, building layout, and environmental dose equivalent distribution, the authors evaluated compliance with exposure limits for staff, researchers, the public, and housed small animals. The simulations confirmed compliance with the 0.250 mSv/year limit for unrestricted areas during daytime operation, with night-time zone restrictions required when staff are absent to allow beam-on quality control. Effective doses to population, researchers, and workers were kept below 1 mSv/year per Legislative Decree 101/2020, with accelerator operators classified as exposed workers, and a precautionary 1 mSv/year limit was adopted for small animals. Lead shielding and site-specific safety measures were used to achieve radiological compliance.
...
[PubMed](https://pubmed.ncbi.nlm.nih.gov/42574718/) · [DOI](https://doi.org/10.1093/rpd/ncag079)
...
*Qin CY, Geng XS, Zhang H, Yu LH, Zhang LG, Dai YZ et al.* — Nature communications (2026)  
...
**TL;DR.** Laser-driven protons with ultrafast temporal properties attract great interest in fields ranging from flash radiation oncology to compact accelerators. High-efficiency energy coupling of protons from laser-induced accelerating fields is complex, hybrid acceleration mechanisms that combine multiple field contributions prove critical for optimizing proton energy.


??? abstract "Summary — AI-generated, curator-reviewed"
    This study reports a laser-driven proton acceleration scheme using near-critical-density foam targets, in which a transition radiation field (TRF) generated by escaping electron bunches supplements the conventional charge-separation field (CSF). Experimentally, electron beams with charges up to ~30 nC and energies above 13 MeV produce TRF pulses with energy up to 0.6 J spanning 0.1-15 THz, corresponding to acceleration fields of 10^12-10^13 V/m. Superposition of TRF and CSF increases proton cut-off energy by more than a factor of two, reaching 90 MeV, and produces a plateau-shaped feature in the high-energy portion of the proton spectrum. Multi-dimensional kinetic simulations are used to confirm the synergistic contribution of TRF and CSF to both energy enhancement and spectral shaping.
...
[PubMed](https://pubmed.ncbi.nlm.nih.gov/42297782/) · [DOI](https://doi.org/10.1038/s41467-026-74298-0) · [Full text (PMC)](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC13409018/)
...
??? abstract "Summary — AI-generated, curator-reviewed"
    This work presents development and characterization of a preclinical 1-2 MeV electron linac platform incorporating a solenoid for magnetic focusing and nested saddle-type scanning magnets for two-dimensional beam steering, intended for shallow FLASH-compatible irradiation with electronically tunable spatial dose modulation. Solenoid focusing reduced the beam size at the 80% isodose diameter from approximately 6 cm to 2 cm, with a measured dose rate of 125 Gy/s at 50 Hz and focused-beam FWHM of 1.26 cm (X) and 1.39 cm (Y). A TOPAS Monte Carlo model incorporating accelerator geometry, titanium exit foil, air gap, and water phantom agreed with Gafchromic EBT-XD film measurements to within about 4% in the high-dose region. Magnetic steering produced tunable three-spot dose distributions with peak-to-peak spacing up to approximately 2.9 cm and peak-to-valley dose ratio up to 28.0, and superposition of scanned beam positions generated a broadened shallow field with a 95% Dmax flat-top width of 2.46 cm.
...
??? abstract "Summary — AI-generated, curator-reviewed"
    This study describes an external beam control system (EBCS) for a modified clinical electron linear accelerator, designed to regulate dose per pulse (DPP) across conventional and ultra-high dose-per-pulse (UH-DPP) delivery over a 6-20 MeV energy range. The system uses radiofrequency power optimization via voltage inputs to the automatic frequency control interface, combined with real-time monitoring through either an internal transmission ion chamber or a multistage beam current transformer, and is interfaced with the accelerator&#x27;s gating system. No tissue, cell, or beam quality/dose-rate irradiation endpoint is reported; the work is limited to characterization of beam control hardware performance.
...
??? abstract "Summary — AI-generated, curator-reviewed"
    This work develops the LIGHT concept, combining a plastic scintillator-based real-time ion radiography detector with a patient-specific 3D range modulator for lung cancer hadron therapy motion management. A 3 cm spherical plastic tumour undergoing breathing-style motion in a mock lung phantom was tracked to 0.1 mm accuracy, with imaging dose approximately one third of comparable x-ray fluoroscopy methods. Modulator positioning reproducibility was measured at 0.3 percent, and a real-time trigger-based switch from imaging to treatment was demonstrated with the mock tumour located at the expected position. An offline simulated dosimetric study reported D95 percent of 98 percent and 99.2 percent for passive and active beam energy switching respectively, compared against standard rescanning motion mitigation.
...
??? abstract "Summary — AI-generated, curator-reviewed"
    This study compares radiobiological effects of laser-plasma-accelerated very high energy electrons (VHEE, mean energy 140.6 MeV) against conventional intermediate energy electrons (CIEE, 7 MeV linac) across three model systems: MRC5-hTERT human fibroblasts (2-10 Gy), mouse precision-cut lung slices (3, 6, 9 Gy), and zebrafish embryos (6 and 9 Gy). Endpoints included clonogenic-type viability survival curves, inhibition of cell replication in lung tissue, and developmental toxicity (body length, spinal curvature) in zebrafish. No significant differences were found between VHEE and CIEE for D10 values in fibroblasts (P=.7), cell division inhibition in lung slices at any dose (P&gt;.99), or developmental toxicity metrics in zebrafish (P≥.5). The abstract does not report dose rates for either beam, so the comparison addresses beam energy/quality equivalence rather than ultra-high versus conventional dose rate effects.
...
??? abstract "Summary — AI-generated, curator-reviewed"
    This work describes a reversible, noninvasive configuration of a clinical TrueBeam linac for ultra-high-dose-rate (UHDR) electron delivery, using built-in service mode software to retract the photon target and monitor chambers and load an unused electron scattering foil, with an external AC current transformer and downstream ionization chamber added for beam monitoring. UHDR electron energies of 9.2 and 12.6 MeV matched conventional-mode energies of 8.4 and 11.7 MeV, with percent depth-dose profiles agreeing through mouse- and cell-culture-relevant thicknesses. Maximum dose per pulse reached 1.5 Gy/pulse at 64 cm SSD (in vivo setup) and 0.7 Gy/pulse at 82 cm SSD (in vitro setup, up to 5x5 cm2 field), with field flatness and symmetry preserved between UHDR and conventional modes. Day-to-day output coefficients of variation averaged under 3% for UHDR and under 1% for conventional delivery.
...
??? abstract "Summary — AI-generated, curator-reviewed"
    This work describes hardware and control-system modifications to PSI Gantry 1, a proton pencil beam scanning unit, to enable true two-dimensional ultra-high dose rate (UHDR) scanning for FLASH research. A second (vertical) scanning direction was added by repurposing an existing steering magnet, inter-spot dead times were minimized via software synchronization of control processes and magnet settling times, and a 1 kHz logging system was introduced to reconstruct lateral dose and dose-rate distributions from recorded beam parameters. The system was commissioned for small fields (100x24 mm2) at gantry angles from 0 degrees to -120 degrees, achieving dose-uniform deliveries at local average dose rates up to 75 Gy/s. Reconstructed lateral dose distributions agreed with CCD measurements on the 90% isodose contour, and reconstructed dose-rate distributions were validated against micro-Diamond detector measurements.
...
*Manjappa R, Wang J, Melemenidis S, Viswanathan V, Ashraf R, Skinner L et al.* — ArXiv (2026)  

<span class="badge oa">Open access</span> <span class="badge tag">Beam Delivery &amp; Technology</span> <span class="badge tag">Radiobiology</span>


**TL;DR.** Clinical linear accelerators are an accessible platform for preclinical research on the biological effects of ultra-rapid electron irradiation (FLASH). However, they are not inherently designed for the accurate pulse control required for experiments using a small number of relatively high-dose pulses, and available methods for beam control such as respiratory gating can be error-prone owing to sys…


??? abstract "Summary — AI-generated, curator-reviewed"
    This work addresses respiratory gating latency on a Varian Trilogy clinical linear accelerator used for preclinical electron FLASH irradiation, characterizing beam-on/beam-off timing errors at 60, 90, and 180 Hz pulse repetition frequencies using custom controller boards and relay circuitry. Mean latencies were 2.0±0.8 ms (60 Hz), 2.1±2.8 ms (90 Hz), and 2.4±1.9 ms (180 Hz) for beam-on, and 1.3±0.9 ms, 1.9±2.9 ms, and 1.8±2.1 ms respectively for beam-off, with similar values across beam-on and beam-off and across frequencies. Two correction methods (adaptive, using only delivered-pulse signal, and synchronization, additionally using internal pulse-timing signal) achieved successful pulse-number delivery exceeding 99% at 90 Hz, and 95% (adaptive) versus 80% (synchronization) at 180 Hz. The authors report that accounting for latency enables reliable delivery of specified pulse counts, including custom pulse sequences not natively supported by the system, for single-fraction and fractionated preclinical dosing regimens. No biological endpoint, dose, or dose-rate value is reported in the abstract; the study is purely instrumentation/engineering focused on pulse-count delivery accuracy.
...
[PubMed](https://pubmed.ncbi.nlm.nih.gov/42094274/) · [Full text (PMC)](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC13142555/)
...
*Kalvala R, Golovanov A, Courvoisier A, Friling T, Kroupp E, Grishko L et al.* — Scientific reports (2026)  

<span class="badge oa">Open access</span> <span class="badge tag">Beam Delivery &amp; Technology</span> <span class="badge tag">Modeling &amp; Mechanisms</span> <span class="badge tag">Clinical &amp; Translational</span>


**TL;DR.** The proposed radiotherapy using very high-energy electron (VHEE) beams generated by a laser-plasma accelerator has garnered significant interest due to its dose distribution capabilities and potential to address limitations of traditional photon-based radiotherapy. To explore the feasibility of such an approach, we develop a start-to-end simulation workflow to model VHEE radiotherapy from the elec…


??? abstract "Summary — AI-generated, curator-reviewed"
    This study presents a start-to-end simulation workflow for very high-energy electron (VHEE) radiotherapy driven by a laser-plasma accelerator, using parameters of the OONA laser (less than 1.3 J, less than 25 fs pulse duration) at the Weizmann Institute of Science. Particle-in-cell simulations generate realistic polychromatic electron beams, which are then transported through a beamline of quadrupoles, a collimator, and dipoles to form a beam array, with GEANT4 used to compute dose deposition in water and heterogeneous bone-insert phantoms. Multifield irradiation from multiple incidence angles is modeled to simulate multi-angle conformal delivery at the isocenter. The workflow demonstrates that polychromatic VHEE beams delivered through this beamline configuration can achieve dose distributions favorable for reaching deep-seated targets within the phantom.
...
[PubMed](https://pubmed.ncbi.nlm.nih.gov/42031987/) · [DOI](https://doi.org/10.1038/s41598-026-49116-8) · [Full text (PMC)](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC13272953/)
...
??? abstract "Summary — AI-generated, curator-reviewed"
    This review surveys emerging FLASH radiotherapy platforms and technical requirements for combining ultra-high dose rate delivery with stereotactic radiosurgery and stereotactic body radiotherapy. It contrasts electron systems, which have supported preclinical FLASH work but have limited penetration for stereotactic use, with photon systems facing engineering barriers in heat management and multi-angle delivery at dose rates above 40 Gy/s, and proton/heavy ion systems that offer Bragg peak advantages but need further development in beam delivery and scanning speed. The paper discusses novel accelerator designs, beam monitoring systems, dosimetry for ultra-high dose rate measurement, quality assurance protocols, treatment planning systems addressing spatial and temporal optimization, and image guidance strategies. No specific preclinical or clinical dose, dose rate, or outcome data from a particular study are reported.
...
*Qian X, Trbojevic D, Brooks S, Tsang T, Cattell R, Kim J et al.* — Journal of radiosurgery and SBRT (2026)  

<span class="badge oa">Open access</span> <span class="badge tag">Beam Delivery &amp; Technology</span>


**TL;DR.** A novel Bragg peak FLASH proton radiation therapy facility using the fixed-magnetic-field synchrotron with kinetic energy range between 10 and 250 MeV will be built at Stony Brook University Hospital. The permanent magnet synchrotron has the shape of a racetrack where the two arcs are made of combined nonlinear fields magnets.


??? abstract "Summary — AI-generated, curator-reviewed"
    This paper describes the design of a Bragg-peak FLASH proton irradiator built around a fixed-magnetic-field permanent magnet synchrotron, planned for installation at Stony Brook University Hospital. The racetrack-shaped accelerator uses combined nonlinear field magnets in its arcs to maintain fixed betatron tunes across a kinetic energy range of 10-250 MeV, targeting delivery of 40 Gy/s within 100 ms, and is designed to fit a 7 x 11 m2 footprint. As an initial physical characterization step, the authors measured a 28 MeV proton beam, reporting a beam width of 7.45 mm (horizontal and vertical), a Bragg peak depth of 6.5 mm, and a peak gap of 8.97 mm. The authors note this low-energy beam distribution is suited to planned small-animal studies.
...
[PubMed](https://pubmed.ncbi.nlm.nih.gov/42004839/) · [Full text (PMC)](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC13007240/)
...
*Cho GS, Kim KT, Lee SS, Kim JH, Lee DH, Chang HS et al.* — PloS one (2026)  

<span class="badge oa">Open access</span> <span class="badge tag">Beam Delivery &amp; Technology</span> <span class="badge tag">Radiobiology</span>


**TL;DR.** FLASH radiation therapy reduced radiation-induced damage to normal tissue, compared to conventional radiation therapy, and active studies have been undertaken worldwide. While a number of preclinical studies have revealed the effectiveness of this novel radiotherapy, the biological effects have not been fully elucidated.


??? abstract "Summary — AI-generated, curator-reviewed"
    This study reports modification of an existing clinical linear accelerator to enable conversion between conventional and ultra-high dose-rate (FLASH) electron beam modes. At 100 cm SSD with a 10 cm x 10 cm applicator, the modified system produced a beam with 9.49 MeV mean energy, an effective field size of 39.9 mm diameter (95% isodose), and a maximum dose rate of 339.1 Gy/s, with flatness of 12.7% and symmetry of 0.3%. The authors report that most preclinical beam requirements were met, but confirmation of the expected 1 Gy/pulse dose value was not achieved in this study. No biological endpoint data are reported; the work is limited to beam characterization and machine engineering.
...
[PubMed](https://pubmed.ncbi.nlm.nih.gov/41996464/) · [DOI](https://doi.org/10.1371/journal.pone.0346577) · [Full text (PMC)](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC13089894/)
...
*Ozoemelam I, Paplanus R, Pillainayagam M, Roberts DA, Litzenberg DW* — Journal of applied clinical medical physics (2026)  
...
**TL;DR.** Preclinical investigations have shown that ultra-high dose rate (UHDR) radiotherapy (&gt;40 Gy/s) also known as FLASH-RT, reduces normal tissue toxicity while preserving tumor control efficacy compared to conventional dose rate treatments. Achieving a UHDR-capable LINAC requires modifications including modifications to electron gun current and bending magnet configurations, use of dedicated energy co…


??? abstract "Summary — AI-generated, curator-reviewed"
    This study describes modification of a decommissioned Varian CLINAC 21EX linear accelerator to deliver ultra-high dose rate (UHDR) electron beams by using 16 MV beam settings with the x-ray target and flattening filter removed, combined with downstream lead scattering foils (0.28-1.2 mm thick) placed at source-to-foil distances of 75.1-90.0 cm. Beam profiles were measured with Gafchromic EBT-XD film at isocenter and evaluated by flatness metrics, alongside percent depth dose measurements to assess Bremsstrahlung contamination. Without a scattering foil, peak dose rates exceeded 200 Gy/s but flatness was 22.0%; standard dual-foil configurations gave good flatness (6.1%) but only 10-11 Gy/s. The downstream scattering configuration achieved dose rates of 43-135 Gy/s with improved flatness (1.2%-3.5% at Dmax for 75.1 cm source-to-foil distance, improving with increasing foil thickness), though thicker foils reduced practical range and increased Bremsstrahlung contribution.
...
[PubMed](https://pubmed.ncbi.nlm.nih.gov/41992376/) · [DOI](https://doi.org/10.1002/acm2.70582) · [Full text (PMC)](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC13086620/)
...
??? abstract "Summary — AI-generated, curator-reviewed"
    This study characterizes collimation of very high-energy electron (VHEE) beams using tungsten, lead, and brass 5 mm diameter collimators, combining film dosimetry with a 200 MeV electron beam at the CERN Linear Electron Accelerator for Research (CLEAR) and Monte Carlo simulations spanning 150-250 MeV and collimator thicknesses of 20-80 mm. Penumbra increased linearly with distance from the collimator in air and was smallest for tungsten. Out-of-field dose decreased with collimator thickness, falling below 0.5% for a 40 mm thick tungsten collimator, while brass produced the broadest penumbra and highest out-of-field dose (up to 4.8%). Monte Carlo models reproduced experimental penumbra trends within 5% but underestimated out-of-field dose, particularly for brass, and simulations showed beam divergence, beam size, and collimator misalignment strongly affect penumbra and out-of-field dose.
...
??? abstract "Summary — AI-generated, curator-reviewed"
    This paper describes an engineering workflow that decouples cone-beam CT image guidance on a Small Animal Radiation Research Platform (SARRP) from a separate collimated treatment beam in a different room, using transferred alignment markers rather than integrated imaging at the point of irradiation. Validation with BB targets in a mouse phantom and a euthanized rat demonstrated setup accuracy of approximately 0.5 mm, matching the isocentricity of the SARRP itself (±0.5 mm). No dose, dose rate, or biological endpoint is reported; the study is a methods/technology development paper intended to enable precise targeting for preclinical studies across modalities including protons, electrons, neutrons, UHDR (FLASH), and small-field RT. The work addresses spatial targeting infrastructure rather than beam generation, dosimetric measurement, or biological response.
...
**TL;DR.** Flash x-ray radiotherapy is an emerging, promising technique for tumor treatment, and a Repetition-rate Linear Induction Accelerator (RLIA) is currently under development at the Institute of Fluid Physics, China Academy of Engineering Physics, for this purpose. To fulfill the demanding high-repetition-rate requirements of RLIA, this paper presents a compact pulse power scheme based on a hydrogen t…


??? abstract "Summary — AI-generated, curator-reviewed"
    This paper describes a pulse-power system developed to drive an induction cavity for a Repetition-rate Linear Induction Accelerator (RLIA) under development at the Institute of Fluid Physics, China Academy of Engineering Physics, intended for flash x-ray radiotherapy. The design uses a hydrogen thyratron-driven tri-coaxial Blumlein pulse forming line to generate burst-mode square-wave pulses with tens-of-kilovolts amplitude, kilohertz repetition rates, and 100-ns pulse widths, which are then amplified through a custom induction voltage adder to reach approximately 100 kV output while preserving the kilohertz repetition rate and 100-ns pulse duration. Experimental results confirm stable generation of square-wave pulses meeting the target specifications for induction cavity drive. No dosimetric, biological, or clinical endpoints are reported.
...
[PubMed](https://pubmed.ncbi.nlm.nih.gov/41891776/) · [DOI](https://doi.org/10.1063/5.0316581)
...
??? abstract "Summary — AI-generated, curator-reviewed"
    This paper describes a fully 3D-printed contoured double passive scattering system developed for the R&amp;D horizontal proton beamline at HollandPTC, designed to shape a 250 MeV proton beam for pre-clinical UHDR radiobiology experiments. The system, fabricated from a tungsten-heavy FDM filament (approximately 75% tungsten by mass), was first optimized via TOPAS Monte Carlo simulation and then validated experimentally. Measured lateral field uniformity exceeded 95%, corresponding to dose homogeneity within ±3% over a 2.8 cm field diameter. Dose rates above 40 Gy/s were achieved, reaching approximately 60 Gy/s at the beam entrance and 100 Gy/s within the spread-out Bragg peak.
...
??? abstract "Summary — AI-generated, curator-reviewed"
    This study characterizes proton emission from titanium hydride (TiH2) targets irradiated in vacuum by a 6-ns, 1064-nm Nd:YAG laser, using time-of-flight measurements with a Faraday cup and an electrostatic ion analyzer. Distinct proton peaks appeared at high pulse energies, with yields on the order of 10^9 protons per shot. Over repeated shots up to 1000, peak amplitude decreased gradually but integrated proton number remained nearly constant, attributed to surface-induced plasma-expansion broadening combined with hydrogen replenishment via diffusion and ablation of fresh TiH2 layers. Scaling from measured proton numbers and pulse widths estimates peak currents of approximately 100 mA with sub-microsecond pulse durations, proposed as a candidate laser ion source for ultra-high-dose-rate injector development.
...
??? abstract "Summary — AI-generated, curator-reviewed"
    This study reports a passive beam modulation technique using tungsten scatterer foils (0.1-3.5 mm thick) placed upstream in an 87.2 MeV synchrotron-based proton research beamline to control dose rate without altering accelerator settings. Full-spill deliveries of approximately 1400 monitor units over approximately 100 ms pulse width produced dose rates ranging from 288.9±0.7 Gy/s at 0.1 mm tungsten to 10.2±0.2 Gy/s at 3.5 mm tungsten, following an inverse exponential relationship between dose rate and scatterer thickness. Geant4 Monte Carlo simulations of dose rate versus thickness were validated experimentally with an Advanced Markus ionization chamber, falling within 95% confidence intervals, and EBT-XD film measurements of lateral dose profiles agreed with simulation to within 2% at beam center, though profiles broadened progressively with increasing scatterer thickness. No biological or tumor model system is involved; this is an engineering/dosimetric characterization of a beam-shaping method spanning conventional to ultra-high dose rate regimes.
...
??? abstract "Summary — AI-generated, curator-reviewed"
    This study evaluates the feasibility of combining proton minibeam radiation therapy (pMBRT) with ultra-high-dose-rate delivery on a clinical IBA Proteus®ONE system equipped with two multi-slit collimators (center-to-center 2.8 mm, slit widths 1.0 mm, thicknesses 6.5 cm and 10 cm). FLASH delivery used 228 MeV protons at 125 nA, compared against clinical beams of 226 MeV at 1-5 nA, with dose distributions measured by Gafchromic film in solid water phantoms and benchmarked against Monte Carlo simulations. Delivery time was reduced from 3 minutes (clinical beam) to 2.5 seconds (UHDR beam) for the same minibeam pattern. The 10 cm collimator produced a peak-to-valley dose ratio of 4.36 at 2 cm depth, compared with 2.57 for the 6.5 cm collimator. No biological endpoints were assessed.
...
??? abstract "Summary — AI-generated, curator-reviewed"
    This paper describes commissioning of a clinical Mevion S250i gantry-mounted 230 MeV proton synchrocyclotron, modified with the Mevion FLASH accessory kit, to deliver spread-out Bragg peak (SOBP) proton FLASH beams for preclinical small-animal studies. A Faraday cup was used to calibrate the integrated FLASHTic transmission ion chamber against integral charge measurements at varying dose rates, and boron carbide absorbers, a range modulating hole filter, and an 11-mm brass aperture were used to shape a single-spot SOBP with an 80%-80% width of 2.01 cm. Peak dose rate at the SOBP proximal peak reached 105.03 Gy/s, with a five-day average of 96.18 Gy/s, and switching between FLASH and clinical delivery modes took under one hour without affecting clinical beam performance. FLASHTic readings correlated strongly with Faraday cup measurements after calibration, supporting its use for beam monitoring and termination.
...
*Winklehner D, Minervini JV, Bromberg L, Forton E, Mandrillon J, Michael PC et al.* — Frontiers in oncology (2025)  

<span class="badge oa">Open access</span> <span class="badge tag">Beam Delivery &amp; Technology</span> <span class="badge tag">Modeling &amp; Mechanisms</span>


**TL;DR.** The advantage of ion beam radiotherapy for cancer lies in its low dose proximal and distal to the tumor, owed to an energy-dependent depth-dose profile, the Bragg-peak. However, conventional techniques to achieve different energies often rely on degraders, which compromise the quality and intensity of the beam and produce secondary radiation.


??? abstract "Summary — AI-generated, curator-reviewed"
    The authors present a conceptual design for a compact, iron-free cyclotron capable of delivering variable-energy ion beams (protons or carbon ions) from 70 to 230 MeV/amu without the use of degraders. Removing magnetic iron from the device produces a linear relationship between coil current and magnetic field, enabling smooth energy scaling and improved magnetic shielding with reduced secondary radiation. The design is based on finite element calculations, particle ray-tracing, and particle-in-cell simulations, and the authors report that the system can deliver the high beam intensity required for FLASH-compatible dose rates across all output energies. No experimental beam data, biological endpoints, or dosimetric measurements are reported.
...
[PubMed](https://pubmed.ncbi.nlm.nih.gov/41195279/) · [DOI](https://doi.org/10.3389/fonc.2025.1648237) · [Full text (PMC)](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC12583090/)
...
??? abstract "Summary — AI-generated, curator-reviewed"
    This study describes a reversible, non-invasive software-based reconfiguration of a clinical TrueBeam linear accelerator to enable ultra-high dose rate electron delivery for preclinical FLASH radiobiology, switching between UHDR and conventional modes without hardware modification. UHDR mode used service-mode software settings with photon-beam RF and current parameters, retraction of the photon target and monitor chamber, and insertion of a clinically unused low-energy scattering foil, with beam monitoring via an external ACCT and dosimetry via radiochromic film and ion chamber. Percent depth dose confirmed comparable electron energies for UHDR (12.8 MeV) and conventional (11.9 MeV) beams with matching profiles through mouse-equivalent thickness. Maximum dose-per-pulse exceeded 0.5 Gy, reaching approximately 1.5 Gy for collimated in vivo setups and approximately 0.7 Gy at extended SSD for tissue culture irradiation, with field flatness and symmetry maintained and output variation under 4% across calibration checks. No biological endpoint was reported; the work is a technical feasibility and dosimetric characterization study.
...
??? abstract "Summary — AI-generated, curator-reviewed"
    This study describes a novel 3D-printed variable-density range-modulating device for proton FLASH therapy, designed to generate spread-out Bragg peaks (SOBPs) from a monoenergetic pencil beam using single-energy scanning. PixelPrint technology varied filament-to-air ratio per voxel to create continuous density gradients rather than the uniform-density spike geometry of current modulators. An inverse optimization algorithm generated density maps for multiple SOBP widths, verified against MCsquare Monte Carlo simulations, and a 3-cm SOBP modulator was fabricated and characterized by dual-energy CT and multi-layer ionization chamber measurements across multiple proton beam energies. The CT scan showed good fidelity to the target density distribution except in the highest-density regions, and MLIC measurements confirmed accurate reproduction of the intended SOBP.
...
<span class="badge tag">Beam Delivery &amp; Technology</span> <span class="badge tag">Modeling &amp; Mechanisms</span> <span class="badge tag">Physics &amp; Dosimetry</span>
...
[PubMed](https://pubmed.ncbi.nlm.nih.gov/40897356/) · [DOI](https://doi.org/10.1088/1361-6560/ae0239)
...
*Zhang Z, Mei Z, Han Q, Li S, Chen K, Zhang G et al.* — Medical physics (2025)  
...
[PubMed](https://pubmed.ncbi.nlm.nih.gov/40517311/) · [DOI](https://doi.org/10.1002/mp.17926)


---

### A novel 3D proton pencil beam scanning scheme and key physical design of the corresponding rapid cycling synchrotron for FLASH delivery.

*Xiong Y, Li Y, Yao H, Zheng S* — Physics in medicine and biology (2025)  
...
[PubMed](https://pubmed.ncbi.nlm.nih.gov/40460851/) · [DOI](https://doi.org/10.1088/1361-6560/ade04a)
...
*Krim DE, Whelan B, Harkness M, Otto K, Loo BW, Bazalova-Carter M* — Scientific reports (2025)  

<span class="badge oa">Open access</span> <span class="badge tag">Beam Delivery &amp; Technology</span> <span class="badge tag">Modeling &amp; Mechanisms</span> <span class="badge tag">Radiobiology</span>
...
[PubMed](https://pubmed.ncbi.nlm.nih.gov/40399395/) · [DOI](https://doi.org/10.1038/s41598-025-02150-4) · [Full text (PMC)](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC12095625/)
...
*Giuliano L, Alesini D, Cardelli F, Carillo M, Chiadroni E, Coppola M et al.* — Frontiers in oncology (2025)  
...
[PubMed](https://pubmed.ncbi.nlm.nih.gov/40134606/) · [DOI](https://doi.org/10.3389/fonc.2025.1516576) · [Full text (PMC)](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC11934386/)
...
*Effarah HH, Reutershan T, Seggebruch MWL, Algots M, Amador A, Baulch J et al.* — Radiation research (2025)  

<span class="badge oa">Open access</span> <span class="badge tag">Beam Delivery &amp; Technology</span> <span class="badge tag">Modeling &amp; Mechanisms</span> <span class="badge tag">Physics &amp; Dosimetry</span> <span class="badge tag">Radiobiology</span>
...
[PubMed](https://pubmed.ncbi.nlm.nih.gov/40084756/) · [DOI](https://doi.org/10.1667/RADE-24-00120.1) · [Full text (PMC)](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC12922569/)
...
*Guo Z, Liu S, Zhou B, Liu J, Wang H, Pi Y et al.* — Nature communications (2025)  

<span class="badge oa">Open access</span> <span class="badge tag">Beam Delivery &amp; Technology</span> <span class="badge tag">Radiobiology</span> <span class="badge tag">Clinical &amp; Translational</span>
...
*Ronga MG, Gesualdi F, Bonfrate A, Patriarca A, Ferrand R, Créhange G et al.* — Medical physics (2025)  
...
??? note "Abstract"
    BACKGROUND: Very high-energy electrons (VHEEs) in radiotherapy may offer several potential advantages over conventional electron beams and other techniques, for example, the fact that they can be used at ultra-high dose rates (UHDRs), therefore enabling FLASH radiotherapy. However, the production of secondary particles at high energies (50-200 MeV) has yet to be studied in detail for this technique currently under development. PURPOSE: The aim of this work was to examine the secondary dose produced by VHEEs, with particular emphasis on bremsstrahlung photons and neutrons, for two beam delivery systems (double scattering \[DS\] and pencil beam scanning \[PBS\]). METHODS: The electron, X-ray, and neutron doses arising from two beam delivery systems (DS or PBS) were computed using Monte Carlo (MC) simulations in the TOPAS (TOol for PArticle Simulation)/Geant4 toolkit, and a preliminary assessment of the secondary dose for a clinical VHEE treatment was performed using a whole-body phantom. An evaluation of the secondary dose produced by this preliminary design of a VHEE nozzle set in a clinical proton facility was performed, taking into account realistic PBS or DS nozzle configurations. RESULTS: The mean doses received by a patient undergoing DS-VHEE irradiation were found to be up to 5.3-fold and 6.8-fold higher for in-field or out-of-field organs for photons and neutrons, respectively, compared to the PBS-VHEE plan. The results for the secondary neutron dose in intracranial treatments also demonstrate the characteristic of VHEE compared to proton beams for reducing the out-of-field secondary neutron dose. The dose to the public area that could be delivered to meet regulatory limits surrounding a possible treatment room in a proton therapy facility was assessed. A regulatory limit of 0.5 µSv/h would give a restriction of 49 and 83 Gy per patient and per fraction for DS and PBS, respectively. CONCLUSIONS: This work describes a method to simulate and compare secondary radiation doses resulting from scattered, scanned VHEE or proton therapy treatments. The results indicate that a conventionally shielded proton therapy room results in acceptable public doses for a preliminary VHEE design and could be of interest for radiation protection purposes and for similar setups. Other facilities with differing layouts may, however, lead to different conclusions, requiring further studies.


[PubMed](https://pubmed.ncbi.nlm.nih.gov/39972099/) · [DOI](https://doi.org/10.1002/mp.17700) · [Full text (PMC)](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC12149673/)
...
*Shou Y, Wu X, Pae KH, Ahn GE, Kim SY, Kim SH et al.* — Nature communications (2025)  
...
*Yagi M, Furutani KM, Ogata T, Nomura T, Umezawa M, Liang X et al.* — Medical physics (2025)  

<span class="badge tag">Beam Delivery &amp; Technology</span> <span class="badge tag">Physics &amp; Dosimetry</span> <span class="badge tag">Treatment Planning &amp; Optimization</span> <span class="badge tag">Modeling &amp; Mechanisms</span>
...
*Barty CPJ, Algots JM, Amador AJ, Barty JCR, Betts SM, Castañeda MA et al.* — ArXiv (2025)  
...
[PubMed](https://pubmed.ncbi.nlm.nih.gov/39148931/) · [Full text (PMC)](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC11326425/)
...
*Guan F, Jiang D, Wang X, Yang M, Iga K, Li Y et al.* — Precision radiation oncology (2024)  

<span class="badge oa">Open access</span> <span class="badge tag">Beam Delivery &amp; Technology</span> <span class="badge tag">Physics &amp; Dosimetry</span> <span class="badge tag">Modeling &amp; Mechanisms</span> <span class="badge tag">Radiobiology</span>
...
*Fischer J, Hart A, Bedriová N, Krim DE, Clements N, Bateman J et al.* — Physics in medicine and biology (2024)  

<span class="badge tag">Beam Delivery &amp; Technology</span> <span class="badge tag">Modeling &amp; Mechanisms</span> <span class="badge tag">Physics &amp; Dosimetry</span> <span class="badge tag">Clinical &amp; Translational</span>
...
*Zink K, Baumann KS, Theiss U, Subtil F, Lahrmann S, Eberle F et al.* — Health and technology (2024)  
...
[PubMed](https://pubmed.ncbi.nlm.nih.gov/39219555/) · [DOI](https://doi.org/10.1007/s12553-024-00881-4) · [Full text (PMC)](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC11358185/)
...
*Dai T, Sloop AM, Ashraf MR, Sunnerberg JP, Clark MA, Bruza P et al.* — Physics in medicine and biology (2024)  
...
[PubMed](https://pubmed.ncbi.nlm.nih.gov/39084661/) · [DOI](https://doi.org/10.1088/1361-6560/ad69fc) · [Full text (PMC)](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC12152580/)
...
<span class="badge tag">Beam Delivery &amp; Technology</span> <span class="badge tag">Physics &amp; Dosimetry</span> <span class="badge tag">Modeling &amp; Mechanisms</span>
...
[PubMed](https://pubmed.ncbi.nlm.nih.gov/38941539/) · [DOI](https://doi.org/10.1002/mp.17245)
...
*Rank L, Lysakovski P, Major G, Ferrari A, Tessonnier T, Debus J et al.* — Medical physics (2024)  
...
[PubMed](https://pubmed.ncbi.nlm.nih.gov/38851210/) · [DOI](https://doi.org/10.1002/mp.17180)
...
*Waid S, Gsponer A, Renner E, Schmitzer C, Kühteubl F, Becker C et al.* — Physics in medicine and biology (2024)  
...
[PubMed](https://pubmed.ncbi.nlm.nih.gov/38788729/) · [DOI](https://doi.org/10.1088/1361-6560/ad5072)
...
*Whitmore L, Mackay RI, van Herk M, Korysko P, Farabolini W, Malyzhenkov A et al.* — Scientific reports (2024)  
...
[PubMed](https://pubmed.ncbi.nlm.nih.gov/38750131/) · [DOI](https://doi.org/10.1038/s41598-024-60997-5) · [Full text (PMC)](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC11096185/)
...
**TL;DR.** More than 70% of tumor patients require radiotherapy. Medical electron linear accelerators are important high-end radiotherapy equipment for tumor radiotherapy.
...
*Sloop A, Ashraf MR, Rahman M, Sunnerberg J, Dexter CA, Thompson L et al.* — International journal of radiation oncology, biology, physics (2024)  

<span class="badge oa">Open access</span> <span class="badge tag">Beam Delivery &amp; Technology</span> <span class="badge tag">Physics &amp; Dosimetry</span> <span class="badge tag">Clinical &amp; Translational</span>


**TL;DR.** In this study, a C-series linear accelerator was configured to enable rapid and reliable conversion between the production of conventional electron beams and an ultrahigh-dose-rate (UHDR) electron beamline to the treatment room isocenter for FLASH radiation therapy. Efforts to tune the beam resulted in a consistent, stable UHDR beamline.
...
[PubMed](https://pubmed.ncbi.nlm.nih.gov/38552990/) · [DOI](https://doi.org/10.1016/j.ijrobp.2024.01.215) · [Full text (PMC)](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC12356227/)
...
*Dai T, Sloop AM, Rahman MR, Sunnerberg JP, Clark MA, Young R et al.* — Medical physics (2024)  

<span class="badge oa">Open access</span> <span class="badge tag">Beam Delivery &amp; Technology</span> <span class="badge tag">Modeling &amp; Mechanisms</span> <span class="badge tag">Physics &amp; Dosimetry</span> <span class="badge tag">Treatment Planning &amp; Optimization</span>


**TL;DR.** FLASH radiotherapy based on ultra-high dose rate (UHDR) is actively being studied by the radiotherapy community. Dedicated UHDR electron devices are currently a mainstay for FLASH studies.
...
[PubMed](https://pubmed.ncbi.nlm.nih.gov/38493501/) · [DOI](https://doi.org/10.1002/mp.17031) · [Full text (PMC)](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC11316970/)
...
*Naceur A, Bienvenue C, Romano P, Chilian C, Carrier JF* — Scientific reports (2024)  

<span class="badge oa">Open access</span> <span class="badge tag">Beam Delivery &amp; Technology</span> <span class="badge tag">Modeling &amp; Mechanisms</span> <span class="badge tag">Clinical &amp; Translational</span> <span class="badge tag">Radiobiology</span>


**TL;DR.** Focused Very-High Energy Electron (VHEE, 50-300 MeV) and Ultra-High Energy Electron (UHEE, &gt; 300 MeV) beams can accurately target both large and deeply seated human tumors with high sparing properties, while avoiding the spatial requirements and cost of proton and heavy ion facilities. Advanced testing phases are underway at the CLEAR facilities at CERN (Switzerland), NLCTA at Stanford (USA), and …
...
[PubMed](https://pubmed.ncbi.nlm.nih.gov/38307920/) · [DOI](https://doi.org/10.1038/s41598-023-51143-8) · [Full text (PMC)](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC11226718/)
...
*Konradsson E, Wahlqvist P, Thoft A, Blad B, Bäck S, Ceberg C et al.* — Frontiers in oncology (2024)  

<span class="badge oa">Open access</span> <span class="badge tag">Beam Delivery &amp; Technology</span> <span class="badge tag">Physics &amp; Dosimetry</span>
...
[PubMed](https://pubmed.ncbi.nlm.nih.gov/38304871/) · [DOI](https://doi.org/10.3389/fonc.2024.1342488) · [Full text (PMC)](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC10830783/)
...
[PubMed](https://pubmed.ncbi.nlm.nih.gov/38295408/) · [DOI](https://doi.org/10.1088/1361-6560/ad247d)
...
*Kutsaev SV, Agustsson R, Boucher S, Carriere P, Ghoniem N, Kaneta K et al.* — Frontiers in medical engineering (2024)  

<span class="badge oa">Open access</span> <span class="badge tag">Beam Delivery &amp; Technology</span> <span class="badge tag">Radiobiology</span> <span class="badge tag">Modeling &amp; Mechanisms</span>


**TL;DR.** This study examines how a practical source of X-ray radiation, capable of delivering unprecedented X-ray of 100 Gy/s at 1 m for X-ray FLASH radiotherapy can be designed. METHODS: We proposed the design of a linac, capable of accelerating 18 MeV 8 mA electron beam with further conversion to bremsstrahlung X-rays.
...
[PubMed](https://pubmed.ncbi.nlm.nih.gov/39925363/) · [DOI](https://doi.org/10.3389/fmede.2024.1382025) · [Full text (PMC)](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC11805532/)
...
*Oesterle R, Bailat C, Buhlmann D, Bochud F, Grilj V* — Medical physics (2024)  

<span class="badge oa">Open access</span> <span class="badge tag">Beam Delivery &amp; Technology</span> <span class="badge tag">Radiobiology</span> <span class="badge tag">Physics &amp; Dosimetry</span>


**TL;DR.** Beam scanning is a useful technique for the treatment of large tumors when the primary beam size is limited, which is the case with radiation beams used in FLASH radiotherapy. PURPOSE: To optimize beam scanning as a dose delivery method for FLASH radiotherapy, it is necessary to first understand the effects of beam scanning on the FLASH effect.
...
[PubMed](https://pubmed.ncbi.nlm.nih.gov/37439505/) · [DOI](https://doi.org/10.1002/mp.16610) · [Full text (PMC)](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC10787038/)
...
*Horváth D, Grittani G, Precek M, Versaci R, Bulanov SV, Olšovcová V* — Physics in medicine and biology (2023)  

<span class="badge tag">Beam Delivery &amp; Technology</span> <span class="badge tag">Modeling &amp; Mechanisms</span> <span class="badge tag">Radiobiology</span>


**TL;DR.** Ultra-short electron beams are used as ultra-fast radiation source for radiobiology experiments aiming at very high energy electron beams (VHEE) radiotherapy with very high dose rates. Laser plasma accelerators are capable of producing electron beams as short as 1 fs and with tunable energy from few MeV up to multi-GeV with compact footprint.
...
[PubMed](https://pubmed.ncbi.nlm.nih.gov/37797651/) · [DOI](https://doi.org/10.1088/1361-6560/ad00a3)
...
*Dal Bello R, von der Grün J, Fabiano S, Rudolf T, Saltybaeva N, Stark LS et al.* — Radiotherapy and oncology : journal of the European Society for Therapeutic Radiology and Oncology (2023)  

<span class="badge tag">Beam Delivery &amp; Technology</span> <span class="badge tag">Radiobiology</span> <span class="badge tag">Physics &amp; Dosimetry</span>


**TL;DR.** Radiotherapy delivery with ultra-high dose rates (UHDR) has consistently produced normal tissue sparing while maintaining efficacy for tumour control in preclinical studies, known as the FLASH effect. Modified clinical electron linacs have been used for pre-clinical studies at reduced source-surface distance (SSD) and novel intra-operative devices are becoming available.
...
[PubMed](https://pubmed.ncbi.nlm.nih.gov/37516362/) · [DOI](https://doi.org/10.1016/j.radonc.2023.109822)
...
*Sunnerberg JP, Zhang R, Gladstone DJ, Swartz HM, Gui J, Pogue BW* — Physics in medicine and biology (2023)  

<span class="badge oa">Open access</span> <span class="badge tag">Beam Delivery &amp; Technology</span> <span class="badge tag">Radiobiology</span> <span class="badge tag">Modeling &amp; Mechanisms</span>


**TL;DR.** Objective. The objective of this study was to investigate the impact of mean and instantaneous dose rates on the production of reactive oxygen species (ROS) during ultra-high dose rate (UHDR) radiotherapy.
...
[PubMed](https://pubmed.ncbi.nlm.nih.gov/37463588/) · [DOI](https://doi.org/10.1088/1361-6560/ace877) · [Full text (PMC)](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC10405361/)
...
*Yogo K, Kodaira S, Kusumoto T, Kitamura H, Toshito T, Iwata H et al.* — Physics in medicine and biology (2023)  

<span class="badge tag">Beam Delivery &amp; Technology</span> <span class="badge tag">Radiobiology</span>


**TL;DR.** Objective.FLASH radiation therapy with ultrahigh dose rates (UHDR) has the potential to reduce damage to normal tissue while maintaining anti-tumor efficacy. However, rapid and precise dose distribution measurements remain difficult for FLASH radiation therapy with proton beams.
...
[PubMed](https://pubmed.ncbi.nlm.nih.gov/37429310/) · [DOI](https://doi.org/10.1088/1361-6560/ace60b)
...
*van Marlen P, van de Water S, Dahele M, Slotman BJ, Verbakel WFAR* — Cancers (2023)  

<span class="badge oa">Open access</span> <span class="badge tag">Beam Delivery &amp; Technology</span> <span class="badge tag">Radiobiology</span> <span class="badge tag">Treatment Planning &amp; Optimization</span>


**TL;DR.** Healthy tissue-sparing effects of FLASH (≥40 Gy/s, ≥4-8 Gy/fraction) radiotherapy (RT) make it potentially useful for whole breast irradiation (WBI), since there is often a lot of normal tissue within the planning target volume (PTV). We investigated WBI plan quality and determined FLASH-dose for various machine settings using ultra-high dose rate (UHDR) proton transmission beams (TBs).
...
[PubMed](https://pubmed.ncbi.nlm.nih.gov/37174045/) · [DOI](https://doi.org/10.3390/cancers15092579) · [Full text (PMC)](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC10177419/)
...
*Cuitiño MC, Fleming JL, Jain S, Cetnar A, Ayan AS, Woollard J et al.* — Advances in radiation oncology (2023)  

<span class="badge oa">Open access</span> <span class="badge tag">Beam Delivery &amp; Technology</span> <span class="badge tag">Radiobiology</span>


**TL;DR.** Increasing evidence suggests that ultra-high-dose-rate (UHDR) radiation could result in similar tumor control as conventional (CONV) radiation therapy (RT) while reducing toxicity to surrounding healthy tissues. Considering that radiation toxicity to gonadal tissues can cause hormone disturbances and infertility in young patients with cancer, the purpose of this study was to assess the possible ro…
...
[PubMed](https://pubmed.ncbi.nlm.nih.gov/37008254/) · [DOI](https://doi.org/10.1016/j.adro.2023.101201) · [Full text (PMC)](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC10050676/)
...
[PubMed](https://pubmed.ncbi.nlm.nih.gov/36697058/) · [DOI](https://doi.org/10.21873/anticanres.16194)
...
*Chaudhary P, Milluzzo G, McIlvenny A, Ahmed H, McMurray A, Maiorino C et al.* — Physics in medicine and biology (2023)  

<span class="badge tag">Beam Delivery &amp; Technology</span> <span class="badge tag">Radiobiology</span> <span class="badge tag">Clinical &amp; Translational</span>


**TL;DR.** Objective.Carbon is an ion species of significant radiobiological interest, particularly in view of its use in cancer radiotherapy, where its large Relative Biological Efficiency is often exploited to overcome radio resistance. A growing interest in highly pulsed carbon delivery has arisen in the context of the development of the FLASH radiotherapy approach, with recent studies carried out at dose…
...
[PubMed](https://pubmed.ncbi.nlm.nih.gov/36625355/) · [DOI](https://doi.org/10.1088/1361-6560/aca387)
...
*Rahman M, Zhang R, Gladstone DJ, Williams BB, Chen E, Dexter CA et al.* — Practical radiation oncology (2023)  

<span class="badge oa">Open access</span> <span class="badge tag">Beam Delivery &amp; Technology</span> <span class="badge tag">Radiobiology</span> <span class="badge tag">Physics &amp; Dosimetry</span> <span class="badge tag">Clinical &amp; Translational</span>


**TL;DR.** The use of a linear accelerator (LINAC) in ultrahigh-dose-rate (UHDR) mode can provide a conduit for wider access to UHDR FLASH effects, sparing normal tissue, but care needs to be taken in the use of such systems to ensure errors are minimized. The failure mode and effects analysis was carried out in a team that has been involved in converting a LINAC between clinical use and UHDR experimental mo…
...
[PubMed](https://pubmed.ncbi.nlm.nih.gov/36375771/) · [DOI](https://doi.org/10.1016/j.prro.2022.10.011) · [Full text (PMC)](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC10373055/)
...
[PubMed](https://pubmed.ncbi.nlm.nih.gov/36550150/) · [DOI](https://doi.org/10.1038/s41598-022-19211-7) · [Full text (PMC)](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC9780319/)
...
*Stephan F, Gross M, Grebinyk A, Aboulbanine Z, Amirkhanyan Z, Budach V et al.* — Physica medica : PM : an international journal devoted to the applications of physics to medicine and biology : official journal of the Italian Association of Biomedical Physics (AIFB) (2022)  

<span class="badge tag">Beam Delivery &amp; Technology</span> <span class="badge tag">Radiobiology</span>


**TL;DR.** At the Photo Injector Test facility at DESY in Zeuthen (PITZ), an R&amp;D platform for electron FLASH and very high energy electron radiation therapy and radiation biology is being prepared (FLASHlab@PITZ). The beam parameters available at PITZ are worldwide unique.
...
[PubMed](https://pubmed.ncbi.nlm.nih.gov/36463582/) · [DOI](https://doi.org/10.1016/j.ejmp.2022.10.026)
...
*Calvo FA, Ayestaran A, Serrano J, Cambeiro M, Palma J, Meiriño R et al.* — Frontiers in oncology (2022)  

<span class="badge oa">Open access</span> <span class="badge tag">Beam Delivery &amp; Technology</span> <span class="badge tag">Radiobiology</span> <span class="badge tag">Clinical &amp; Translational</span> <span class="badge tag">Modeling &amp; Mechanisms</span>


**TL;DR.** Oligo-recurrent disease has a consolidated evidence of long-term surviving patients due to the use of intense local cancer therapy. The latter combines real-time surgical exploration/resection with high-energy electron beam single dose of irradiation.
...
[PubMed](https://pubmed.ncbi.nlm.nih.gov/36452493/) · [DOI](https://doi.org/10.3389/fonc.2022.1037262) · [Full text (PMC)](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC9703091/)
...
*Faillace L, Alesini D, Bisogni G, Bosco F, Carillo M, Cirrone P et al.* — Physica medica : PM : an international journal devoted to the applications of physics to medicine and biology : official journal of the Italian Association of Biomedical Physics (AIFB) (2022)  
...
**TL;DR.** In order to translate the FLASH effect in clinical use and to treat deep tumors, Very High Electron Energy irradiations could represent a valid technique. Here, we address the main issues in the design of a VHEE FLASH machine.
...
*Farr J, Grilj V, Malka V, Sudharsan S, Schippers M* — Medical physics (2022)  

<span class="badge oa">Open access</span> <span class="badge tag">Beam Delivery &amp; Technology</span> <span class="badge tag">Radiobiology</span>


**TL;DR.** Higher dose rates, a trend for radiotherapy machines, can be beneficial in shortening treatment times for radiosurgery and mitigating the effects of motion. Recently, even higher doses (e.g., 100 times greater) have become targeted because of their potential to generate the FLASH effect (FE).
...
[PubMed](https://pubmed.ncbi.nlm.nih.gov/35403262/) · [DOI](https://doi.org/10.1002/mp.15659) · [Full text (PMC)](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC9544515/)
...
*Winter J, Dimroth A, Roetzer S, Zhang Y, Krämer KL, Petrich C et al.* — Medical physics (2022)  

<span class="badge tag">Beam Delivery &amp; Technology</span> <span class="badge tag">Modeling &amp; Mechanisms</span> <span class="badge tag">Radiobiology</span> <span class="badge tag">Clinical &amp; Translational</span>


**TL;DR.** Microbeam and x-ray FLASH radiation therapy are innovative concepts that promise reduced normal tissue toxicity in radiation oncology without compromising tumor control. However, currently only large third-generation synchrotrons deliver acceptable x-ray beam qualities and there is a need for compact, hospital-based radiation sources to facilitate clinical translation of these novel treatment stra…
...
[PubMed](https://pubmed.ncbi.nlm.nih.gov/35315089/) · [DOI](https://doi.org/10.1002/mp.15611)
...
*Esplen N, Egoriti L, Paley B, Planche T, Hoehr C, Gottberg A et al.* — Physics in medicine and biology (2022)  

<span class="badge tag">Beam Delivery &amp; Technology</span> <span class="badge tag">Modeling &amp; Mechanisms</span> <span class="badge tag">Radiobiology</span>


**TL;DR.** To develop a bremsstrahlung target and megavoltage (MV) x-ray irradiation platform for ultrahigh dose-rate (UHDR) irradiation of small-animals on the Advanced Rare Isotope Laboratory (ARIEL) electron linac (e-linac) at TRIUMF. APPROACH: An electron-to-photon converter design for UHDR radiotherapy (RT) was centered around optimization of a tantalum-aluminum (Ta-Al) explosion-bonded target.
...
[PubMed](https://pubmed.ncbi.nlm.nih.gov/35299167/) · [DOI](https://doi.org/10.1088/1361-6560/ac5ed6)
...
*Perstin A, Poirier Y, Sawant A, Tambasco M* — International journal of radiation oncology, biology, physics (2022)  

<span class="badge tag">Beam Delivery &amp; Technology</span> <span class="badge tag">Radiobiology</span>


**TL;DR.** To investigate a plasmid DNA nicking assay approach for isolating and quantifying the DNA-damaging effects of ultrahigh-dose-rate (ie, FLASH) irradiation relative to conventional dose-rate irradiation. METHODS AND MATERIALS: We constructed and irradiated phantoms containing plasmid DNA to nominal doses of 20 Gy and 30 Gy using 16 MeV electrons at conventional (0.167 Gy/s) and FLASH (46.6 Gy/s and …
...
[PubMed](https://pubmed.ncbi.nlm.nih.gov/35124135/) · [DOI](https://doi.org/10.1016/j.ijrobp.2022.01.049)
...
*Gonçalves Jorge P, Grilj V, Bourhis J, Vozenin MC, Germond JF, Bochud F et al.* — Medical physics (2022)  

<span class="badge oa">Open access</span> <span class="badge tag">Beam Delivery &amp; Technology</span> <span class="badge tag">Physics &amp; Dosimetry</span> <span class="badge tag">Clinical &amp; Translational</span>


**TL;DR.** The Oriatron eRT6 is a linear accelerator (linac) used in FLASH preclinical studies able to reach dose rates ranging from conventional (CONV) up to ultrahigh (UHDR). This work describes the implementation of commercially available beam current transformers (BCTs) as online monitoring tools compatible with CONV and UHDR irradiations for preclinical FLASH studies.
...
[PubMed](https://pubmed.ncbi.nlm.nih.gov/35066878/) · [DOI](https://doi.org/10.1002/mp.15474) · [Full text (PMC)](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC9303205/)
...
<span class="badge oa">Open access</span> <span class="badge tag">Beam Delivery &amp; Technology</span> <span class="badge tag">Modeling &amp; Mechanisms</span> <span class="badge tag">Radiobiology</span> <span class="badge tag">Treatment Planning &amp; Optimization</span>


**TL;DR.** To present a Monte Carlo (MC) beam model and its implementation in a clinical treatment planning system (TPS, Varian Eclipse) for a modified ultrahigh dose-rate electron FLASH radiation therapy (eFLASH-RT) linear accelerator (LINAC) using clinical accessories and geometry. METHODS AND MATERIALS: The gantry head without scattering foils or targets, representative of the LINAC modifications, was mod…
...
*Sarti A, De Maria P, Battistoni G, De Simoni M, Di Felice C, Dong Y et al.* — Frontiers in oncology (2021)  

<span class="badge oa">Open access</span> <span class="badge tag">Beam Delivery &amp; Technology</span> <span class="badge tag">Modeling &amp; Mechanisms</span> <span class="badge tag">Radiobiology</span> <span class="badge tag">Treatment Planning &amp; Optimization</span>


**TL;DR.** radiotherapy with photons (RT), particle therapy (PT) with protons or even heavier ions like 12C, are now available in clinical centres. In addition to these irradiation modalities, the use of Very High Energy Electron (VHEE) beams (100-200 MeV) has been suggested in the past, but the diffusion of that technique was delayed due to the needed space and budget, with respect to standard photon device…
...
[PubMed](https://pubmed.ncbi.nlm.nih.gov/35024354/) · [DOI](https://doi.org/10.3389/fonc.2021.777852) · [Full text (PMC)](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC8744000/)
...
*Masilela TAM, Delorme R, Prezado Y* — Scientific reports (2021)  

<span class="badge oa">Open access</span> <span class="badge tag">Beam Delivery &amp; Technology</span> <span class="badge tag">Modeling &amp; Mechanisms</span> <span class="badge tag">Physics &amp; Dosimetry</span>


**TL;DR.** Very high energy electrons (VHEEs) represent a promising alternative for the treatment of deep-seated tumors over conventional radiotherapy (RT), owing to their favourable dosimetric characteristics. Given the high energy of the electrons, one of the concerns has been the production of photoneutrons.
...
[PubMed](https://pubmed.ncbi.nlm.nih.gov/34642417/) · [DOI](https://doi.org/10.1038/s41598-021-99645-7) · [Full text (PMC)](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC8511248/)
...
*Oesterle R, Gonçalves Jorge P, Grilj V, Bourhis J, Vozenin MC, Germond JF et al.* — Journal of applied clinical medical physics (2021)  

<span class="badge oa">Open access</span> <span class="badge tag">Beam Delivery &amp; Technology</span> <span class="badge tag">Physics &amp; Dosimetry</span>


**TL;DR.** To implement and validate a beam current transformer as a passive monitoring device on a pulsed electron beam medical linear accelerator (LINAC) for ultra-high dose rate (UHDR) irradiations in the operational range of at least 3 Gy to improve dosimetric procedures currently in use for FLASH radiotherapy (FLASH-RT) studies. METHODS: Two beam current transformers (BCTs) were placed at the exit of a …
...
[PubMed](https://pubmed.ncbi.nlm.nih.gov/34609051/) · [DOI](https://doi.org/10.1002/acm2.13433) · [Full text (PMC)](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC8598141/)
...
[PubMed](https://pubmed.ncbi.nlm.nih.gov/34287938/) · [DOI](https://doi.org/10.1002/mp.15105)
...
*Whitmore L, Mackay RI, van Herk M, Jones JK, Jones RM* — Scientific reports (2021)  

<span class="badge oa">Open access</span> <span class="badge tag">Beam Delivery &amp; Technology</span> <span class="badge tag">Modeling &amp; Mechanisms</span>


**TL;DR.** This paper presents the first demonstration of deeply penetrating dose delivery using focused very high energy electron (VHEE) beams using quadrupole magnets in Monte Carlo simulations. We show that the focal point is readily modified by linearly changing the quadrupole magnet strength only.
...
[PubMed](https://pubmed.ncbi.nlm.nih.gov/34234203/) · [DOI](https://doi.org/10.1038/s41598-021-93276-8) · [Full text (PMC)](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC8263594/)
...
*Delorme R, Masilela TAM, Etoh C, Smekens F, Prezado Y* — Scientific reports (2021)  

<span class="badge oa">Open access</span> <span class="badge tag">Beam Delivery &amp; Technology</span> <span class="badge tag">Radiobiology</span> <span class="badge tag">Physics &amp; Dosimetry</span> <span class="badge tag">Modeling &amp; Mechanisms</span>


**TL;DR.** Very high energy electrons (VHEEs, E &gt; 70 MeV) present promising clinical advantages over conventional beams due to their increased range, improved penumbra and relative insensitivity to tissue heterogeneities. They have recently garnered additional interest in their application to spatially fractionated radiotherapy or ultra-high dose rate (FLASH) therapy.
...
[PubMed](https://pubmed.ncbi.nlm.nih.gov/34045625/) · [DOI](https://doi.org/10.1038/s41598-021-90805-3) · [Full text (PMC)](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC8160353/)
...
*Nesteruk KP, Togno M, Grossmann M, Lomax AJ, Weber DC, Schippers JM et al.* — Medical physics (2021)  

<span class="badge tag">Beam Delivery &amp; Technology</span>


**TL;DR.** The purpose of this work was to provide a flexible platform for FLASH research with protons by adapting a former clinical pencil beam scanning gantry to irradiations with ultra-high dose rates. METHODS: PSI Gantry 1 treated patients until December 2018.
...
[PubMed](https://pubmed.ncbi.nlm.nih.gov/33963576/) · [DOI](https://doi.org/10.1002/mp.14933)
...
*Böhlen TT, Germond JF, Traneus E, Bourhis J, Vozenin MC, Bailat C et al.* — Medical physics (2021)  

<span class="badge tag">Beam Delivery &amp; Technology</span> <span class="badge tag">Modeling &amp; Mechanisms</span> <span class="badge tag">Radiobiology</span> <span class="badge tag">Physics &amp; Dosimetry</span>


**TL;DR.** Driven by advances in accelerator technology and the potential of exploiting the FLASH effect for the treatment of deep-seated targets (&gt;5 cm), there is an active interest in the construction of devices to deliver very high-energy electron (VHEE) beams for radiation therapy. The application of novel VHEE devices, however, requires an assessment of the tradeoffs between the different beam parameter…
...
[PubMed](https://pubmed.ncbi.nlm.nih.gov/33884618/) · [DOI](https://doi.org/10.1002/mp.14891)
...
[PubMed](https://pubmed.ncbi.nlm.nih.gov/33712653/) · [DOI](https://doi.org/10.1038/s41598-021-85451-8) · [Full text (PMC)](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC7971008/)
...
**TL;DR.** When relativistic electrons are used to irradiate tissues, such as during FLASH pre-clinical irradiations, the electron beam energy is one of the critical parameters that determine the dose distribution. Moreover, during such irradiations, linear accelerators (linacs) usually operate with significant beam loading, where a small change in the accelerator output current can lead to beam energy reduc…
...
[PubMed](https://pubmed.ncbi.nlm.nih.gov/33361551/) · [DOI](https://doi.org/10.1088/1361-6560/abd672) · [Full text (PMC)](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC8208618/)
...
*Schüller A, Heinrich S, Fouillade C, Subiel A, De Marzi L, Romano F et al.* — Physica medica : PM : an international journal devoted to the applications of physics to medicine and biology : official journal of the Italian Association of Biomedical Physics (AIFB) (2020)  

<span class="badge tag">Beam Delivery &amp; Technology</span> <span class="badge tag">Physics &amp; Dosimetry</span>


**TL;DR.** UHDpulse - Metrology for advanced radiotherapy using particle beams with ultra-high pulse dose rates is a recently started European Joint Research Project with the aim to develop and improve dosimetry standards for FLASH radiotherapy, very high energy electron (VHEE) radiotherapy and laser-driven medical accelerators. This paper gives a short overview about the current state of developments of rad…
...
[PubMed](https://pubmed.ncbi.nlm.nih.gov/33181444/) · [DOI](https://doi.org/10.1016/j.ejmp.2020.09.020)
...
*Labate L, Palla D, Panetta D, Avella F, Baffigi F, Brandi F et al.* — Scientific reports (2020)  

<span class="badge oa">Open access</span> <span class="badge tag">Beam Delivery &amp; Technology</span>


**TL;DR.** Radiotherapy with very high energy electrons has been investigated for a couple of decades as an effective approach to improve dose distribution compared to conventional photon-based radiotherapy, with the recent intriguing potential of high dose-rate irradiation. Its practical application to treatment has been hindered by the lack of hospital-scale accelerators.
...
[PubMed](https://pubmed.ncbi.nlm.nih.gov/33057078/) · [DOI](https://doi.org/10.1038/s41598-020-74256-w) · [Full text (PMC)](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC7560873/)
...
*Breitkreutz DY, Shumail M, Bush KK, Tantawi SG, Maxime PG, Loo BW* — Radiation research (2020)  

<span class="badge oa">Open access</span> <span class="badge tag">Beam Delivery &amp; Technology</span> <span class="badge tag">Modeling &amp; Mechanisms</span> <span class="badge tag">Physics &amp; Dosimetry</span> <span class="badge tag">Radiobiology</span>


**TL;DR.** In this work, we investigated the delivery of a clinically acceptable pediatric whole brain radiotherapy plan at FLASH dose rates using two lateral opposing 40-MeV electron beams produced by a practically realizable linear accelerator system. The EGSnrc Monte Carlo software modules, BEAMnrc and DOSXYZnrc, were used to generate whole brain radiotherapy plans for a pediatric patient using two latera…
...
[PubMed](https://pubmed.ncbi.nlm.nih.gov/32991725/) · [DOI](https://doi.org/10.1667/RADE-20-00069.1) · [Full text (PMC)](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC7856241/)
...
*Srinivasan S, Duperrex PA, Schippers JM* — Physica medica : PM : an international journal devoted to the applications of physics to medicine and biology : official journal of the Italian Association of Biomedical Physics (AIFB) (2020)  

<span class="badge tag">Beam Delivery &amp; Technology</span> <span class="badge tag">Physics &amp; Dosimetry</span>


**TL;DR.** At PSI (Paul Scherrer Institute), Switzerland, a superconducting cyclotron called &quot;COMET&quot; delivers proton beam of 250 MeV pulsed at 72.85 MHz for proton radiation therapy. Measuring proton beam currents (0.1-10nA) is of crucial importance for the treatment safety and is usually performed with invasive monitors such as ionisation chambers (ICs) which degrade the beam quality.
...
[PubMed](https://pubmed.ncbi.nlm.nih.gov/32956916/) · [DOI](https://doi.org/10.1016/j.ejmp.2020.09.006)
...
*Jolly S, Owen H, Schippers M, Welsch C* — Physica medica : PM : an international journal devoted to the applications of physics to medicine and biology : official journal of the Italian Association of Biomedical Physics (AIFB) (2020)  

<span class="badge tag">Beam Delivery &amp; Technology</span> <span class="badge tag">Physics &amp; Dosimetry</span> <span class="badge tag">Radiobiology</span>


**TL;DR.** There is growing interest in the radiotherapy community in the application of FLASH radiotherapy, wherein the dose is delivered to the entire treatment volume in less than a second. Early pre-clinical evidence suggests that these extremely high dose rates provide significant sparing of healthy tissue compared to conventional radiotherapy without reducing the damage to cancerous cells.
...
[PubMed](https://pubmed.ncbi.nlm.nih.gov/32947086/) · [DOI](https://doi.org/10.1016/j.ejmp.2020.08.005)
...
*Folkerts MM, Abel E, Busold S, Perez JR, Krishnamurthi V, Ling CC* — Medical physics (2020)  

<span class="badge oa">Open access</span> <span class="badge tag">Beam Delivery &amp; Technology</span>


**TL;DR.** To develop a method of (a) calculating the dose rate of voxels within a proton field delivered using pencil beam scanning (PBS), and (b) reporting a representative dose rate for the PBS treatment field that enables correspondence between multiple treatment modalities. This method takes into account the unique spatiotemporal delivery patterns of PBS FLASH radiotherapy.
...
[PubMed](https://pubmed.ncbi.nlm.nih.gov/32910460/) · [DOI](https://doi.org/10.1002/mp.14456) · [Full text (PMC)](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC7894358/)
...
*Ko RB, Soto LA, von Eyben R, Melemenidis S, Rankin EB, Maxim PG et al.* — Radiation research (2020)  

<span class="badge oa">Open access</span> <span class="badge tag">Beam Delivery &amp; Technology</span> <span class="badge tag">Radiobiology</span>


**TL;DR.** The observation of an enhanced therapeutic index for FLASH radiotherapy in mice has created interest in practical laboratory-based FLASH irradiators. To date, systems capable of 3D conformal FLASH irradiation in mice have been lacking.
...
[PubMed](https://pubmed.ncbi.nlm.nih.gov/32857849/) · [DOI](https://doi.org/10.1667/RADE-20-00095) · [Full text (PMC)](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC7856226/)
...
*Wing M* — Philosophical transactions. Series A, Mathematical, physical, and engineering sciences (2019)  

<span class="badge oa">Open access</span> <span class="badge tag">Beam Delivery &amp; Technology</span>


**TL;DR.** New particle acceleration schemes open up exciting opportunities, potentially providing more compact or higher-energy accelerators. The AWAKE experiment at CERN is currently taking data to establish the method of proton-driven plasma wakefield acceleration.
...
[PubMed](https://pubmed.ncbi.nlm.nih.gov/31230578/) · [DOI](https://doi.org/10.1098/rsta.2018.0185) · [Full text (PMC)](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC6602917/)
...
*Hanton F, Chaudhary P, Doria D, Gwynne D, Maiorino C, Scullion C et al.* — Scientific reports (2019)  

<span class="badge oa">Open access</span> <span class="badge tag">Beam Delivery &amp; Technology</span> <span class="badge tag">Radiobiology</span> <span class="badge tag">Physics &amp; Dosimetry</span>


**TL;DR.** Protontherapy has emerged as more effective in the treatment of certain tumors than photon based therapies. However, significant capital and operational costs make protontherapy less accessible.
...
[PubMed](https://pubmed.ncbi.nlm.nih.gov/30872656/) · [DOI](https://doi.org/10.1038/s41598-019-40339-6) · [Full text (PMC)](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC6418121/)
...
*Lempart M, Blad B, Adrian G, Bäck S, Knöös T, Ceberg C et al.* — Radiotherapy and oncology : journal of the European Society for Therapeutic Radiology and Oncology (2019)  

<span class="badge tag">Beam Delivery &amp; Technology</span> <span class="badge tag">Physics &amp; Dosimetry</span>


**TL;DR.** The purpose of this study was to modify a clinical linear accelerator, making it capable of electron beam ultra-high dose rate (FLASH) irradiation. Modifications had to be quick, reversible, and without interfering with clinical treatments.
...
[PubMed](https://pubmed.ncbi.nlm.nih.gov/30755324/) · [DOI](https://doi.org/10.1016/j.radonc.2019.01.031)
...
*Adli E, Ahuja A, Apsimon O, Apsimon R, Bachmann AM, Barrientos D et al.* — Nature (2018)  

<span class="badge oa">Open access</span> <span class="badge tag">Beam Delivery &amp; Technology</span>


**TL;DR.** High-energy particle accelerators have been crucial in providing a deeper understanding of fundamental particles and the forces that govern their interactions. To increase the energy of the particles or to reduce the size of the accelerator, new acceleration schemes need to be developed.
...
[PubMed](https://pubmed.ncbi.nlm.nih.gov/30188496/) · [DOI](https://doi.org/10.1038/s41586-018-0485-4) · [Full text (PMC)](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC6786972/)
...
[PubMed](https://pubmed.ncbi.nlm.nih.gov/28339108/) · [DOI](https://doi.org/10.1002/mp.12233)
...
*Schüler E, Trovati S, King G, Lartey F, Rafat M, Villegas M et al.* — International journal of radiation oncology, biology, physics (2017)  

<span class="badge tag">Beam Delivery &amp; Technology</span> <span class="badge tag">Physics &amp; Dosimetry</span> <span class="badge tag">Modeling &amp; Mechanisms</span> <span class="badge tag">Radiobiology</span>


**TL;DR.** A key factor limiting the effectiveness of radiation therapy is normal tissue toxicity, and recent preclinical data have shown that ultra-high dose rate irradiation (&gt;50 Gy/s, &quot;FLASH&quot;) potentially mitigates this effect. However, research in this field has been strongly limited by the availability of FLASH irradiators suitable for small animal experiments.
...
[PubMed](https://pubmed.ncbi.nlm.nih.gov/27816362/) · [DOI](https://doi.org/10.1016/j.ijrobp.2016.09.018)
...
*Bazalova-Carter M, Liu M, Palma B, Dunning M, McCormick D, Hemsing E et al.* — Medical physics (2015)  

<span class="badge tag">Beam Delivery &amp; Technology</span> <span class="badge tag">Modeling &amp; Mechanisms</span> <span class="badge tag">Physics &amp; Dosimetry</span>


**TL;DR.** To measure radiation dose in a water-equivalent medium from very high-energy electron (VHEE) beams and make comparisons to Monte Carlo (MC) simulation results. METHODS: Dose in a polystyrene phantom delivered by an experimental VHEE beam line was measured with Gafchromic films for three 50 MeV and two 70 MeV Gaussian beams of 4.0-6.9 mm FWHM and compared to corresponding MC-simulated dose distribu…
...
[PubMed](https://pubmed.ncbi.nlm.nih.gov/25832051/) · [DOI](https://doi.org/10.1118/1.4914371)
...
*Garnica-Garza HM* — Applied radiation and isotopes : including data, instrumentation and methods for use in agriculture, industry and medicine (2014)  

<span class="badge tag">Beam Delivery &amp; Technology</span> <span class="badge tag">Modeling &amp; Mechanisms</span>


**TL;DR.** With the advent of compact laser-based electron accelerators, there has been some renewed interest on the use of such charged particles for radiotherapy purposes. Traditionally, electrons have been used for the treatment of fairly superficial lesions located at depths of no more than 4cm inside the patient, but lately it has been proposed that by using very high energy electrons, i.e.
...
[PubMed](https://pubmed.ncbi.nlm.nih.gov/25151497/) · [DOI](https://doi.org/10.1016/j.apradiso.2014.07.018)
...
*Fuchs T, Szymanowski H, Oelfke U, Glinec Y, Rechatin C, Faure J et al.* — Physics in medicine and biology (2009)  

<span class="badge tag">Beam Delivery &amp; Technology</span> <span class="badge tag">Modeling &amp; Mechanisms</span> <span class="badge tag">Physics &amp; Dosimetry</span> <span class="badge tag">Treatment Planning &amp; Optimization</span>


**TL;DR.** In recent experiments, quasi-monoenergetic and well-collimated very-high energy electron (VHEE) beams were obtained by laser-plasma accelerators. We investigate their potential use for radiation therapy.
...
[PubMed](https://pubmed.ncbi.nlm.nih.gov/19430107/) · [DOI](https://doi.org/10.1088/0031-9155/54/11/003)
...
*Yeboah C, Sandison GA, Moskvin V* — Physics in medicine and biology (2002)  

<span class="badge tag">Beam Delivery &amp; Technology</span> <span class="badge tag">Modeling &amp; Mechanisms</span> <span class="badge tag">Radiobiology</span>


**TL;DR.** This work evaluates the potential of very high energy (50-250 MeV) electron beams for dose conformation and identifies those variables that influence optimized dose distributions for this modality. Intensity-modulated plans for a prostate cancer model were optimized as a function of the importance factors, beam energy and number of energy bins, number of beams, and the beam orientations.
...
*Berry RJ* — British medical bulletin (1973)  

<span class="badge tag">Beam Delivery &amp; Technology</span>


[PubMed](https://pubmed.ncbi.nlm.nih.gov/4208646/) · [DOI](https://doi.org/10.1093/oxfordjournals.bmb.a070955)
